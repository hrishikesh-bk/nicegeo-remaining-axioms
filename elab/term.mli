...
(** Elaboration-level terms. Contains location information for precision in error messages. *)
type term = {
  inner : termkind;
  loc : range;
}
...
(** [bind_bvar tm bvar_idx pat] replaces all occurrences of [pat] in [tm] with a
    reference to the bound variable at de Bruijn depth [bvar_idx]. *)
