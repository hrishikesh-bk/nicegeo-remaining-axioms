(**
   This file contains the kernel-side exception types, to be passed
   to the elaborator for processing.
 *)
open Term
...
(**
   ...
   AppArgTypeError: Type error for the argument of a function application, where
   the terms represent (1) the function, (2) the argument, (3) the type of the 
   function, (4) the expected type of the argument, and (5) the actual type of 
   the argument.
 *)
